...
'''
Please run the code to get the output. There is main output
'''
...
if __name__ == '__main__':
    log_file = 'TenGreatestHittersOUTPUT.txt'
    f = open(log_file, "w")
    ...
    print("playerID first_name last_name career_average career_hits career_at_bats first_year last_year")
    for idx,i in enumerate(out6):
        print('\n{} {} {} {} {} {} {} {}'.format(i[0], i[1]['first_name'], i[1]['last_name'],i[1]['batting_avg'],i[1]['H'],i[1]['AB'],i[1]['first_yr'],i[1]['last_yr']))
        if idx ==9:
            break
    f.write("playerID first_name last_name career_average career_hits career_at_bats first_year last_year")
    for idx,i in enumerate(out6):
        f.write('{} {} {} {} {} {} {} {}'.format(i[0], i[1]['first_name'], i[1]['last_name'],i[1]['batting_avg'],i[1]['H'],i[1]['AB'],i[1]['first_yr'],i[1]['last_yr']))
        if idx ==9:
            break
    f.close()        
